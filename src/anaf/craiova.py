craiova={
    "Administratia Judeteana a Finantelor Publice DOLJ": {
        ...
        "Unitatea Fiscala Oraseneasca Calafat": [
            ...
            "Plenita", "Poiana Mare", "Seaca de Camp", "Unirea"
        ],
        "Unitatea Fiscala Oraseneasca Filiasi": [
            "Bradesti", "Bralostita", "Cotofenii din Dos", "Cotofenii din Fata", "Farcas", "Filiasi", "Melinesti",
            "Scaesti", "Talpas"
        ],
        "Unitatea Fiscala Oraseneasca Segarcea": [
            "Barca", "Bistret", "Calopar", "Carna", "Cerat", "Dranic", "Gangiova", "Giurgita", "Goicea", "Macesu de Jos",
            "Macesu de Sus", "Segarcea", "Valea Stanciului"
        ],
        "Unitatea Fiscala Oraseneasca Bechet": [
            "Bechet", "Calarasi", "Dabuleni", "Dobresti", "Gighera", "Ostroveni", "Sadova"
        ],
        "Unitatea Fiscala Oraseneasca Bailesti": [
            "Afumati", "Bailesti", "Catane", "Cioroiasi", "Galicea Mare", "Galiciuica", "Giubega",
    ...
    "Administratia Judeteana a Finantelor Publice GORJ" : {
        ...
        "Unitatea Fiscala Oraseneasca Targu Carbunesti": [
            ...
            "Prigoria", "Rosia de Amaradia", "Saulesti", "Scoarta", "Stejari", "Stoina", "Targu Carbunesti", "Turburea", "Tantareni", "Ticleni", "Vladimir"
        ],
        "Unitatea Fiscala Oraseneasca Rovinari": [
    ...
    "Administratia Judeteana a Finantelor Publice MEHEDINTI": {
        ...
        "Unitatea Fiscala Oraseneasca Vanju Mare": [
            "Balacita", "Branistea", "Burila Mare", "Corlatel", "Cujmir", "Darvari", "Devesel", "Garla Mare", "Gogosu", "Gruia", 
            "Jiana", "Livezile", "Obarsia de Camp", "Oprisor", "Padina", "Patulele", "Poroina Mare", "Pristol", "Punghina", "Rogova", "Salcia", 
    ...
    "Administratia Judeteana a Finantelor Publice OLT": {
        ...
        "Unitatea Fiscala Oraseneasca Bals" : [
            "Baldovinesti", "Bals", "Barza", "Bobicesti", "Calui", "Dobretu", "Gavanesti", "Iancu Jianu", "Morunglav",
            "Oboga", "Parscoveni", "Soparlita", "Voineasa", "Vulpeni"
        ],
        "Unitatea Fiscala Oraseneasca Corabia": [
            "Brastavatu", "Cilieni", "Corabia", "Garcov", "Giuvarasti", "Grojdibodu", "Gura Padinii", "Ianca", "Izbiceni", "Obarsia", "Orlea", "Rusanesti", 
    ...
    "Administratia Judeteana a Finantelor Publice VALCEA" : {
        ...
        "Unitatea Fiscala Municipala Dragasani": [
            ...
            "Prundeni", "Scundu", "Stefanesti", "Susani", "Sutesti", "Voicesti"
        ],
        "Unitatea Fiscala Oraseneasca Balcesti": [
            "Balcesti", "Diculesti", "Fartatesti", "Fauresti", "Ghioroiu", "Lacusteni", "Lalosu", "Maciuca", "Rosiile", "Stanesti", "Tetoiu", "Valea Mare"
        ],
        "Unitatea Fiscala Oraseneasca Gura Lotrului": [
            "Boisoara", "Brezoi", "Caineni", "Malaia", "Perisani", "Racovita", "Titesti", "Voineasa"
        ],
